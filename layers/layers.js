...
lyr_GoogleSatelliteHybrid_0.setVisible(false);lyr_GoogleSatellite_1.setVisible(true);lyr_GoogleRoads_2.setVisible(false);lyr_OpenTopoMap_3.setVisible(false);lyr_Sungai_4.setVisible(true);lyr_Jalan_5.setVisible(true);lyr_AreaFungsional_6.setVisible(true);lyr_JalurPipa_7.setVisible(true);lyr_KETERANGAN_KERUSAKAN_SALURAN_8.setVisible(true);lyr_JENIS_SALURAN_9.setVisible(true);lyr_AREANOMENKLATUR_10.setVisible(true);lyr_BANGUNANNOMENKLATUR_11.setVisible(true);lyr_Tikungan_12.setVisible(true);lyr_Beda_Pasangan_13.setVisible(true);lyr_Gorong__Gorong_14.setVisible(true);lyr_Titik_Per50_m_15.setVisible(true);lyr_Box_Gate_Valve_16.setVisible(true);lyr_Box_Alva_Valve_17.setVisible(true);lyr_Bangunan_Bagi_18.setVisible(true);lyr_Bangunan_Sadap_19.setVisible(true);lyr_Rumah_Pompa_20.setVisible(true);
...
lyr_AreaFungsional_6.set('fieldImages', {'Id': 'TextEdit', 'LUAS': 'TextEdit', 'AREA': 'TextEdit', });
